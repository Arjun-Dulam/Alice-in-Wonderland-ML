...
\end{table}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=5.5in]{../miscImages/gradientCheckpoint.png} 
            \label{fig:example}
        \end{figure}
    \end{itemize}
\end{itemize}
...
\end{itemize}
    ...
    \begin{itemize}
        ...
        Selecting subgradients at every step of an iterative descent procedure is called subgradient descent.
    \end{itemize}
\end{document} 